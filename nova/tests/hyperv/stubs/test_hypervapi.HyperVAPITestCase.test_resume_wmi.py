...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="3E7675BA-3DCA\
-4B1D-A120-E23E24CF9E83"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="645ACF53-7EB7\
-473F-99C9-9B45079B306F"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="495F3FAD-6D5\
A-42DD-B0D9-7F19FBFF71E0"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="D2D81D0E-ACF\
4-4F93-8B00-67D6ABB58967"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="5589CCD1-DC8\
C-4761-80EE-5781C143BC9B"':
        ret_value = None
        global _WMI_count_8
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="7E4B06BD-2A6\
0-41CE-A3DC-7D98360C1CD8"':
        ret_value = None
        global _WMI_count_9
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="303FBDB7-8BD\
B-4CDD-9EB6-181744C35F63"':
        ret_value = None
...
3e737\'':
            v = []
            return v
        elif self.__id__ == 388 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_8e61a5f0-a997-4642-993\
d-5b2933bad05f\\openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            v = []
            v1 = _wmi_object()
 ...
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 386 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 389 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 393 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 398 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.014448:000'
        elif self.__id__ == 359:
            return u'00000000000000.791156:000'
        elif self.__id__ == 377:
            return u'00000000000001.023259:000'
    ...
    def Connection(self):
        if self.__id__ == 410:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_8e61a5f0-a997-4642-993\
d-5b2933bad05f\\openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f.vh\
d'
            v += (v1,)
            return v
    ...
    def JobState(self):
        if self.__id__ == 14:
            ...
            ret_value = None
            if not hasattr(self, '_JobState_count_37'):
                self._JobState_count_37 = 0
            if self._JobState_count_37 == 0:
                v = 7
            elif self._JobState_count_37 == 1:
                v = 7
            self._JobState_count_37 += 1
            return v
        elif self.__id__ == 418:
            return 4
        elif self.__id__ == 419:
            ret_value = None
            if not hasattr(self, '_JobState_count_39'):
                self._JobState_count_39 = 0
            if self._JobState_count_39 == 0:
                v = 7
            elif self._JobState_count_39 == 1:
                v = 7
            self._JobState_count_39 += 1
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 379 and wmi_association_class ==\
...
Data.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:9F2BB2A8-D8\
33-48F5-9455-45E5B461CF8E\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\4764334d\
...
ingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:9F2BB2A8\
-D833-48F5-9455-45E5B461CF8E\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad\
05f</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>abe394a6-f252-453a-96f1-870e598aed69</VALUE\
...
t_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f\\openstack_unit_test_vm_8e61a5f\
0-a997-4642-993d-5b2933bad05f.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>a358ae28-ffa5-4190-9992-b708ea903af7</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{43110d36-e027-4580-b3c4-79df15daf6c4}</VAL\
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 421:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 24 and kwargs.get('Path') ==\
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_8e61a5f0-a997-4642-993d\
-5b2933bad05f\\openstack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="645ACF53-\
7EB7-473F-99C9-9B45079B306F"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="495F3FAD\
-6D5A-42DD-B0D9-7F19FBFF71E0"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="5589CCD1\
-DC8C-4761-80EE-5781C143BC9B"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"' and\
...
ySettingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:9F2BB2A8-D8\
33-48F5-9455-45E5B461CF8E\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:9F2BB2A8\
-D833-48F5-9455-45E5B461CF8E\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B46\
1CF8E\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_8e61a5f0-a997-4642-993d-5b2933bad05f\\\\openstack_unit_test_\
vm_8e61a5f0-a997-4642-993d-5b2933bad05f.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B46\
1CF8E\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\AD8ED815-0B46-4AA1\
-A4A1-7B935B98E778\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{c376b985-dec2-4468-8fba-0a442805b2c2}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E\\\\4F01EB47-3A5D-4\
B66-B3AC-8DFC381C4E31"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="3E7675BA-\
3DCA-4B1D-A120-E23E24CF9E83"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 362 and args[0] == 32769:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="D2D81D0E\
-ACF4-4F93-8B00-67D6ABB58967"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 395 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="7E4B06BD\
-2A60-41CE-A3DC-7D98360C1CD8"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 384 and str(args[0]) == '[100,\
 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
            v2 = CDispatch()
            v2.__instance_id__ = 385
            v1.append(v2)
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 416 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="303FBDB7\
-8BDB-4CDD-9EB6-181744C35F63"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"'
        elif len(args) == 0 and self.__id__ == 383:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_VirtualSystemSettingData.Instanc\
eID="Microsoft:9F2BB2A8-D833-48F5-9455-45E5B461CF8E"'
        elif len(args) == 0 and self.__id__ == 417:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="9F2BB2A8-D833-48F5-9455-45E5B461CF8E"'
