...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="4FDA6367-8A6B\
-4EAE-B5A8-ED5D61CCE5B5"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="C0531E74-9EEB\
-4582-AF42-E039E2D0E95B"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="4D404F03-A80\
A-431B-B0E4-D5EEF06307AE"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="D1A2DB93-80D\
9-44BF-A915-924F6AFAB10A"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="1686339B-47B\
1-4D54-AC7D-8956E20A5D3E"':
        ret_value = None
        global _WMI_count_8
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="EFC4352F-C61\
E-481D-8909-D1CE6C617CA7"':
        ret_value = None
        global _WMI_count_9
...
7ee2b\'':
 ...
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a0\
2-d7a3be306ebc\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc.vh\
d\'':
            v = []
            v1 = _wmi_object(412)
            v.append(v1)
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc':
            v = []
            v1 = _wmi_object(49)
            v.append(v1)
            return v
...
class _wmi_object(object):
    ...
    def ElementName(self):
        if self.__id__ == 362:
            return\
 u'openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc'
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.010983:000'
        elif self.__id__ == 360:
            return u'00000000000000.829755:000'
        elif self.__id__ == 369:
            return u'00000000000001.215675:000'
    ...
    def Connection(self):
        if self.__id__ == 402:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a0\
2-d7a3be306ebc\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc.vh\
d'
            v += (v1,)
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 371 and wmi_association_class ==\
...
Data.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:45777C3B-FF\
47-4091-93E0-0DEB77ACF0C9\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\4764334d\
...
ingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:45777C3B\
-FF47-4091-93E0-0DEB77ACF0C9\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306\
ebc</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>e574cfc2-9328-42f7-943c-9baff65109f9</VALUE\
...
t_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc\\openstack_unit_test_vm_f20cbe8\
4-2bc5-4fd7-9a02-d7a3be306ebc.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>03fde2f5-099b-493a-a2a5-aca64f355bb1</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{7fc13fc3-0ab1-48b8-9bfe-022a900e2f99}</VAL\
...
class _wmi_method(object):
 ...
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02\
-d7a3be306ebc\\openstack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="C0531E74-\
9EEB-4582-AF42-E039E2D0E95B"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="4D404F03\
-A80A-431B-B0E4-D5EEF06307AE"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 365 and args[0] == 10:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="D1A2DB93\
-80D9-44BF-A915-924F6AFAB10A"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"' and\
...
ySettingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:45777C3B-FF\
47-4091-93E0-0DEB77ACF0C9\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:45777C3B\
-FF47-4091-93E0-0DEB77ACF0C9\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77A\
CF0C9\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc\\\\openstack_unit_test_\
vm_f20cbe84-2bc5-4fd7-9a02-d7a3be306ebc.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77A\
CF0C9\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\91E4FA57-C497-40A7\
-8294-A7989503331E\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{a7146cc1-1da6-4277-b24c-e27d5762839d}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9\\\\69502824-F6D6-4\
6E3-B93E-4A5626BAE43E"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="4FDA6367-\
8A6B-4EAE-B5A8-ED5D61CCE5B5"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="1686339B\
-47B1-4D54-AC7D-8956E20A5D3E"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 376 and str(args[0]) == '[100,\
 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
...
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="EFC4352F\
-C61E-481D-8909-D1CE6C617CA7"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="45777C3B-FF47-4091-93E0-0DEB77ACF0C9"'
        elif len(args) == 0 and self.__id__ == 375:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_VirtualSystemSettingData.Instanc\
eID="Microsoft:45777C3B-FF47-4091-93E0-0DEB77ACF0C9"'
