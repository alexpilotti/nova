...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="41CE47D5-8E2E\
-4F1F-923C-3B1D1E98FF41"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="CDA8CBAE-7477\
-4CD8-ADC2-F0951952614E"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="25D3ABCC-820\
4-4994-9ABA-F8F9D1367BDB"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="A1B094CC-92C\
8-41CB-8E8A-B63E0B3DAF8A"':
        v = _wmi_object()
        v.__instance_id__ = 362
        return v
    elif moniker ==\
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="0526EE26-665\
3-4900-AF2E-A600AA86A72D"':
        ret_value = None
        global _WMI_count_8
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="C5622DB7-905\
7-49E2-8475-7CD30217057D"':
        ret_value = None
        global _WMI_count_9
...
3e737\'':
 ...
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbb\
d-57dac43705cb\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb':
            v = []
            v1 = _wmi_object()
 ...
 'openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 359 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def Description(self):
        if self.__id__ == 33:
            ...
            return u'Pausing Virtual Machine'
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.016497:000'
        elif self.__id__ == 358:
            return u'00000000000000.751513:000'
        elif self.__id__ == 362:
            return u'00000000000000.066529:000'
    ...
    def Connection(self):
        if self.__id__ == 395:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbb\
d-57dac43705cb\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb.vh\
d'
            v += (v1,)
            return v
...
Data.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:EA8E66EA-7D\
17-4EBB-8913-30D563060A58\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\4764334d\
...
ingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:EA8E66EA\
-7D17-4EBB-8913-30D563060A58\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac4370\
5cb</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>0b56311b-78f8-4fe0-b158-05d20c0034d3</VALUE\
...
t_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb\\openstack_unit_test_vm_85ab3a4\
7-94ec-4486-bbbd-57dac43705cb.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>afd3b17a-a2c3-4118-b238-2cf4dd721267</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{046d0d92-716f-4ea2-823d-aeb19a122d77}</VAL\
...
class _wmi_method(object):
 ...
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd\
-57dac43705cb\\openstack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="CDA8CBAE-\
7477-4CD8-ADC2-F0951952614E"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="25D3ABCC\
-8204-4994-9ABA-F8F9D1367BDB"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 361 and args[0] == 32768:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="A1B094CC\
-92C8-41CB-8E8A-B63E0B3DAF8A"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="EA8E66EA-7D17-4EBB-8913-30D563060A58"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="EA8E66EA-7D17-4EBB-8913-30D563060A58"' and\
...
ySettingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:EA8E66EA-7D\
17-4EBB-8913-30D563060A58\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:EA8E66EA\
-7D17-4EBB-8913-30D563060A58\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D5630\
60A58\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_85ab3a47-94ec-4486-bbbd-57dac43705cb\\\\openstack_unit_test_\
vm_85ab3a47-94ec-4486-bbbd-57dac43705cb.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D5630\
60A58\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="EA8E66EA-7D17-4EBB-8913-30D563060A58"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\5B21F642-9142-4E6D\
-985A-F3414843A626\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{d013e562-def0-4da9-97ef-f9c5a28930df}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58\\\\E5D876EB-BEAE-4\
C6D-A227-B463542840D9"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="41CE47D5-\
8E2E-4F1F-923C-3B1D1E98FF41"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="0526EE26\
-6653-4900-AF2E-A600AA86A72D"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 369 and str(args[0]) == '[100,\
 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
            v2 = CDispatch()
            v2.__instance_id__ = 370
            v1.append(v2)
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="EA8E66EA-7D17-4EBB-8913-30D563060A58"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="C5622DB7\
-9057-49E2-8475-7CD30217057D"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
eID="Microsoft:EA8E66EA-7D17-4EBB-8913-30D563060A58"'
