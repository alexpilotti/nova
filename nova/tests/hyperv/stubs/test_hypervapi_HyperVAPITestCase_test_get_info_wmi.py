...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="BDF0957B-5712\
-4BDA-A45C-251610440D79"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="52CE1119-FCE2\
-42B8-A7C4-9ECC34E4C5C6"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="9ABA1FBF-7B9\
1-4284-B1B2-87D6753B53A3"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="B832D26E-78D\
4-482F-8CE7-9A67F008D9A7"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="B68DCBDB-242\
2-4657-B6EC-64708C91B3A3"':
        ret_value = None
        global _WMI_count_8
...
7ee2b\'':
            v = []
            return v
        elif self.__id__ == 373 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_e1ea28f0-2279-46c2-bee\
1-4e09d613d272\\openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272.vh\
d\'':
            v = []
            v1 = _wmi_object(405)
            v.append(v1)
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 371 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272':
            v = []
            v1 = _wmi_object(372)
            v.append(v1)
...
class _wmi_object(object):
    ...
    def ElementName(self):
        if self.__id__ == 362:
            return\
 u'openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272'
    ...
    def ElapsedTime(self):
        if self.__id__ == 34:
            return u'00000000000001.015166:000'
        elif self.__id__ == 360:
            return u'00000000000000.645121:000'
    ...
    def Connection(self):
        if self.__id__ == 395:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_e1ea28f0-2279-46c2-bee\
1-4e09d613d272\\openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272.vh\
d'
            v += (v1,)
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 364 and wmi_association_class ==\
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 385 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object(386)
            v.append(v1)
...
Data.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:0738B59A-A3\
83-46D9-B0C1-DCB69AEEEEE3\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\4764334d\
...
ingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:0738B59A\
-A383-46D9-B0C1-DCB69AEEEEE3\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d\
272</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>0f11dba6-29e6-4b4a-9933-a7c1c7924bf3</VALUE\
...
t_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272\\openstack_unit_test_vm_e1ea28f\
0-2279-46c2-bee1-4e09d613d272.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>34a561a2-4866-4526-91c0-0a8e86e99969</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{5c4069e6-b856-4db9-8891-d5cc5a255e87}</VAL\
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 406:
            v = ()
            v1 = 0
            v += (v1,)
            return v
...
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="52CE1119-\
FCE2-42B8-A7C4-9ECC34E4C5C6"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="9ABA1FBF\
-7B91-4284-B1B2-87D6753B53A3"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"' and\
...
ySettingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:0738B59A-A3\
83-46D9-B0C1-DCB69AEEEEE3\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:0738B59A\
-A383-46D9-B0C1-DCB69AEEEEE3\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AE\
EEEE3\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_e1ea28f0-2279-46c2-bee1-4e09d613d272\\\\openstack_unit_test_\
vm_e1ea28f0-2279-46c2-bee1-4e09d613d272.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AE\
EEEE3\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\ACEFC5CD-F550-4AC3\
-9F80-35DD2307C1AB\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{7600ea53-bfa0-42ae-a413-841c89f75b81}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3\\\\6E6C6B80-39DB-4\
6D6-8EAD-6C298E55A8EA"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 369 and str(args[0]) == '[4,\
 100, 103, 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="BDF0957B-\
5712-4BDA-A45C-251610440D79"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 380 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="B832D26E\
-78D4-482F-8CE7-9A67F008D9A7"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 401 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="B68DCBDB\
-2422-4657-B6EC-64708C91B3A3"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
eID="Microsoft:0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"'
        elif len(args) == 0 and self.__id__ == 402:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="0738B59A-A383-46D9-B0C1-DCB69AEEEEE3"'
