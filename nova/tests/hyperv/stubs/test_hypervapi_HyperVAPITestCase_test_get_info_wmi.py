...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="27849E61-E1F3\
-4C26-A0B4-58C24409046F"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="D270FF5B-0ECF\
-45B0-B099-8FA2EF883390"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="479F7F70-68F\
B-4650-9D0E-B099A5975DA9"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="9AD61017-9F3\
6-4B35-813B-4BA95DD3BA95"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="506D8F5B-62B\
6-478B-B4AD-430BA5B50BCB"':
        ret_value = None
        global _WMI_count_8
...
7ee2b\'':
            v = []
            return v
        elif self.__id__ == 372 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_429af6a7-195b-4300-9d7\
7-fa1cabc1bd59\\openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElementName(self):
        if self.__id__ == 361:
            return\
 u'openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59'
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.009524:000'
        elif self.__id__ == 359:
            return u'00000000000000.734883:000'
    ...
    def Connection(self):
        if self.__id__ == 394:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_429af6a7-195b-4300-9d7\
7-fa1cabc1bd59\\openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59.vh\
d'
            v += (v1,)
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 363 and wmi_association_class ==\
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 384 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 383 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
...
Data.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:A5F7A72D-3B\
A2-4104-B3C7-69869E34360A\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\4764334d\
...
ingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:A5F7A72D\
-3BA2-4104-B3C7-69869E34360A\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1b\
d59</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>2f1d150e-7a69-4467-b847-f3490f28dcd5</VALUE\
...
t_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59\\openstack_unit_test_vm_429af6a\
7-195b-4300-9d77-fa1cabc1bd59.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>55f87773-7b1f-4fdb-b230-0ce16730b835</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{bda8e037-3720-47b0-ae22-64fd717b2d5f}</VAL\
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 405:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 24 and kwargs.get('Path') ==\
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_429af6a7-195b-4300-9d77\
-fa1cabc1bd59\\openstack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="D270FF5B-\
0ECF-45B0-B099-8FA2EF883390"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="479F7F70\
-68FB-4650-9D0E-B099A5975DA9"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="A5F7A72D-3BA2-4104-B3C7-69869E34360A"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="A5F7A72D-3BA2-4104-B3C7-69869E34360A"' and\
...
ySettingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:A5F7A72D-3B\
A2-4104-B3C7-69869E34360A\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:A5F7A72D\
-3BA2-4104-B3C7-69869E34360A\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E3\
4360A\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_429af6a7-195b-4300-9d77-fa1cabc1bd59\\\\openstack_unit_test_\
vm_429af6a7-195b-4300-9d77-fa1cabc1bd59.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E3\
4360A\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="A5F7A72D-3BA2-4104-B3C7-69869E34360A"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\E91F25EB-6932-4F5E\
-ADA5-EB46F66A4459\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{ea11e057-17e2-4052-9d24-754007332135}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A\\\\AA30F6B8-63CA-4\
2DD-9350-4E3868B73C1C"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 368 and str(args[0]) == '[4,\
 100, 103, 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
            v2 = CDispatch()
            v2.__instance_id__ = 369
            v1.append(v2)
            v += (v1,)
            return v
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="27849E61-\
E1F3-4C26-A0B4-58C24409046F"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 379 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="9AD61017\
-9F36-4B35-813B-4BA95DD3BA95"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 400 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="A5F7A72D-3BA2-4104-B3C7-69869E34360A"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="506D8F5B\
-62B6-478B-B4AD-430BA5B50BCB"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
class CDispatch(object):
    ...
    def NumberOfProcessors(self):
        if self.__id__ == 369:
            ret_value = None
            if not hasattr(self, '_NumberOfProcessors_count_0'):
                self._NumberOfProcessors_count_0 = 0
            if self._NumberOfProcessors_count_0 == 0:
                v = 1
            elif self._NumberOfProcessors_count_0 == 1:
                v = 1
            self._NumberOfProcessors_count_0 += 1
            return v

    @NumberOfProcessors.setter
    def NumberOfProcessors(self, value):
        pass
    ...
    def EnabledState(self):
        if self.__id__ == 369:
            ret_value = None
            if not hasattr(self, '_EnabledState_count_0'):
                self._EnabledState_count_0 = 0
            if self._EnabledState_count_0 == 0:
                v = 2
            elif self._EnabledState_count_0 == 1:
                v = 2
            self._EnabledState_count_0 += 1
            return v
    ...
    def MemoryUsage(self):
        if self.__id__ == 369:
            ret_value = None
            if not hasattr(self, '_MemoryUsage_count_0'):
                self._MemoryUsage_count_0 = 0
            if self._MemoryUsage_count_0 == 0:
                v = u'512'
            elif self._MemoryUsage_count_0 == 1:
                v = u'512'
            elif self._MemoryUsage_count_0 == 2:
                v = u'512'
            self._MemoryUsage_count_0 += 1
            return v
 ...
 u'Microsoft:Definition\\BDE5D4D6-E450-46D2-B925-976CA3E989B4\\Default'
    ...
    def UpTime(self):
        if self.__id__ == 369:
            ret_value = None
            if not hasattr(self, '_UpTime_count_0'):
                self._UpTime_count_0 = 0
            if self._UpTime_count_0 == 0:
                v = u'281'
            elif self._UpTime_count_0 == 1:
                v = u'281'
            self._UpTime_count_0 += 1
            return v
...
eID="Microsoft:A5F7A72D-3BA2-4104-B3C7-69869E34360A"'
        elif len(args) == 0 and self.__id__ == 401:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="A5F7A72D-3BA2-4104-B3C7-69869E34360A"'
