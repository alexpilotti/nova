...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="5C849ACF-2C2F\
-450F-B556-4A238A7D7FB4"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="DCC87E42-F0E9\
-4650-9241-6C305DC63425"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="47255D79-A3C\
E-410A-99F9-864A64146595"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="64991A35-8BD\
7-461B-8DE3-8D7512F9E48C"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="7183BC12-731\
7-4DFD-BAAD-B67F64DB073B"':
        ret_value = None
        global _WMI_count_8
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="1A9C7639-937\
9-4DF3-862D-4DB2F2849371"':
        ret_value = None
        global _WMI_count_9
...
3e737\'':
 ...
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-937\
0-40cd6a22c7c3\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElementName(self):
        if self.__id__ == 361:
            return\
 u'openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3'
    ...
    def Description(self):
        if self.__id__ == 33:
            ...
            return u'Resetting Virtual Machine'
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.015949:000'
        elif self.__id__ == 359:
            return u'00000000000000.846693:000'
        elif self.__id__ == 368:
            return u'00000000000000.481862:000'
    ...
    def Connection(self):
        if self.__id__ == 401:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-937\
0-40cd6a22c7c3\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3.vh\
d'
            v += (v1,)
            return v
...
Data.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:AAE589BB-DD\
29-4AF9-B784-BE097D58B3BF\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\4764334d\
...
ingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:AAE589BB\
-DD29-4AF9-B784-BE097D58B3BF\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c\
7c3</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>5175fe8a-0ba3-4ead-9531-b5f919ac2782</VALUE\
...
t_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3\\openstack_unit_test_vm_86c0c8f\
6-4bf6-4119-9370-40cd6a22c7c3.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>2801e697-5d13-4860-9de4-7f75cb15d5e6</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{00c65f44-e575-4e7e-afe4-c9cd19872f11}</VAL\
...
class _wmi_method(object):
 ...
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370\
-40cd6a22c7c3\\openstack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="DCC87E42-\
F0E9-4650-9241-6C305DC63425"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="47255D79\
-A3CE-410A-99F9-864A64146595"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 364 and args[0] == 10:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="64991A35\
-8BD7-461B-8DE3-8D7512F9E48C"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="AAE589BB-DD29-4AF9-B784-BE097D58B3BF"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="AAE589BB-DD29-4AF9-B784-BE097D58B3BF"' and\
...
ySettingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:AAE589BB-DD\
29-4AF9-B784-BE097D58B3BF\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:AAE589BB\
-DD29-4AF9-B784-BE097D58B3BF\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D5\
8B3BF\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3\\\\openstack_unit_test_\
vm_86c0c8f6-4bf6-4119-9370-40cd6a22c7c3.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D5\
8B3BF\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="AAE589BB-DD29-4AF9-B784-BE097D58B3BF"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\8C778BBC-46CD-4C6A\
-98CC-5D5702B9E6BE\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{20777aa5-e181-4b51-ade4-508910bc0589}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF\\\\33537440-E6C2-4\
6A0-A7B6-BB3EB98BBEAD"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="5C849ACF-\
2C2F-450F-B556-4A238A7D7FB4"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="7183BC12\
-7317-4DFD-BAAD-B67F64DB073B"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
ata.InstanceID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
...
="Msvm_ComputerSystem",Name="AAE589BB-DD29-4AF9-B784-BE097D58B3BF"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="1A9C7639\
-9379-4DF3-862D-4DB2F2849371"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
eID="Microsoft:AAE589BB-DD29-4AF9-B784-BE097D58B3BF"'
