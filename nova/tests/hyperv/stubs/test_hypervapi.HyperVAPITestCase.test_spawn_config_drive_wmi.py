...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="C7383415-32E8\
-4EDA-A528-08675B75DC4A"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="BF8F57C5-1437\
-4E6B-BFF4-F1B1A42DE169"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="E965EAFD-1C2\
9-4E9D-BAFC-E850C2386140"':
        ret_value = None
        global _WMI_count_6
        ...
        if _WMI_count_6 == 0:
            ...
            v = _wmi_object()
            v.__instance_id__ = 567
        elif _WMI_count_6 == 7:
            v = _wmi_object()
            v.__instance_id__ = 568
        _WMI_count_6 += 1
        return v
    elif moniker ==\
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="D23CEBB1-904\
A-41C6-9298-CF79C7EB1F23"':
        ret_value = None
        global _WMI_count_7
        ...
        if _WMI_count_7 == 0:
            v = _wmi_object()
            v.__instance_id__ = 599
        elif _WMI_count_7 == 1:
            v = _wmi_object()
            v.__instance_id__ = 600
        _WMI_count_7 += 1
        return v
    elif moniker ==\
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="E4359C48-780\
3-431C-BC53-D630440E4069"':
        ret_value = None
        global _WMI_count_8
...
3e737\'':
            v = []
            return v
        elif self.__id__ == 591 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_5276dd6f-fd3a-41da-879\
9-352039c91e80\\openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80.vh\
d\'':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 625
            v.append(v1)
            return v
        elif self.__id__ == 591 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_5276dd6f-fd3a-41da-879\
9-352039c91e80\\configdrive.vhd\'':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 627
            v.append(v1)
            return v
 ...
 \'%Default%\'':
            ret_value = None
            if not hasattr(self, '_query_count_4'):
 ...
 \'%Default%\' ':
            ret_value = None
            if not hasattr(self, '_query_count_5'):
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 558 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 559
            v.append(v1)
            return v
        elif self.__id__ == 36:
            v = []
            ...
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 462
            v.append(v1)
            return v
        elif self.__id__ == 554:
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 555
            v.append(v1)
            return v
        elif self.__id__ == 569 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            v = []
            v1 = _wmi_object()
 ...
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 593
            v.append(v1)
            return v
        elif self.__id__ == 596 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 597
            v.append(v1)
            return v
        elif self.__id__ == 601 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElapsedTime(self):
        if self.__id__ == 35:
            return u'00000000000001.007712:000'
        elif self.__id__ == 568:
            return u'00000000000000.943344:000'
    ...
    def Connection(self):
        if self.__id__ == 581:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_5276dd6f-fd3a-41da-879\
9-352039c91e80\\openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80.vh\
d'
            v += (v1,)
            return v
...
9-352039c91e80\\configdrive.vhd'
    ...
    def JobState(self):
        if self.__id__ == 14:
            ...
            return 4
        elif self.__id__ == 566:
            return 4
        elif self.__id__ == 567:
            return 4
        elif self.__id__ == 568:
            ret_value = None
            ...
            ret_value = None
            if not hasattr(self, '_JobState_count_31'):
                self._JobState_count_31 = 0
            if self._JobState_count_31 == 0:
                v = 7
            elif self._JobState_count_31 == 1:
                v = 7
            self._JobState_count_31 += 1
            return v
    ...
    def Delete(self):
        if self.__id__ == 625:
            v = _wmi_method()
            v.__instance_id__ = 626
            return v
        elif self.__id__ == 627:
            v = _wmi_method()
            v.__instance_id__ = 628
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 355 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 571 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 586
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 587
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 588
            v.append(v1)
            return v
        elif self.__id__ == 570 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 603 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 618
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 619
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 620
            v.append(v1)
            return v
        elif self.__id__ == 602 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
...
Data.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:E5ED67FD-32\
44-4E93-807F-CB3BB7C22ED2\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\4764334d\
...
ingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:E5ED67FD\
-3244-4E93-807F-CB3BB7C22ED2\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91\
e80</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>2db2b60d-dcbf-451c-b550-83dfeb068c53</VALUE\
...
t_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80\\openstack_unit_test_vm_5276dd6\
f-fd3a-41da-8799-352039c91e80.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>547f2602-93d4-40d5-b1e8-21775ca79561</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{ca0617eb-d040-4008-a0b7-561358e1e071}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
        elif self.__id__ == 373 and iObjectTextFormat == 1:
            return u'<INSTANCE\
 CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY NAME="__PATH"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__NAMESPACE"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__SERVER"\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>d2f216ef-4d56-4189-92e6-73abd638fe8e</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
        elif self.__id__ == 467 and iObjectTextFormat == 1:
            return u'<INSTANCE\
 CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY NAME="__PATH"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__NAMESPACE"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__SERVER"\
...
OPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>C:\\Hyper-V\\test\\instances\\openstack_uni\
t_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80\\configdrive.vhd</VALUE></VALUE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>8bf956f4-f8ff-4da5-aec8-ed8f97145b2b</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 626:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 628:
            v = ()
            v1 = 0
            v += (v1,)
            return v
...
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="BF8F57C5-\
1437-4E6B-BFF4-F1B1A42DE169"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 560 and args[0] == 2:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="E965EAFD\
-1C29-4E9D-BAFC-E850C2386140"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"' and\
...
ySettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:E5ED67FD-32\
44-4E93-807F-CB3BB7C22ED2\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:E5ED67FD\
-3244-4E93-807F-CB3BB7C22ED2\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C\
22ED2\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80\\\\openstack_unit_test_\
vm_5276dd6f-fd3a-41da-8799-352039c91e80.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C\
22ED2\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\20592739-B485-4467\
-9406-FD43549E088E\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{81c6465e-c9fc-40df-832d-7be5fdc33ff6}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\47E3A50E-ABD5-4\
1DC-802D-A6563B4C9830"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 463 and str(args[0]) ==\
 '[u\'<INSTANCE CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY\
 NAME="__PATH" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__NAMESPACE" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__SERVER" CLASSORIGIN="___SYSTEM"\
...
EA8F\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C\
22ED2\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\1"</VALUE></PROPERTY>\
<PROPERTY NAME="PoolID" CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="string"><VALUE>Microsoft:118C3BE5-0D31-4804-85F0-5C6074ABEA8F\\\\Root</\
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
...
-9EDA-2CA8B33039B4\\\\1\\\\0\\\\D"'
            ...
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 556 and str(args[0]) ==\
 '[u\'<INSTANCE CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY\
 NAME="__PATH" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__NAMESPACE" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__SERVER" CLASSORIGIN="___SYSTEM"\
...
OPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>C:\\\\Hyper-V\\\\test\\\\instances\\\\opens\
tack_unit_test_vm_5276dd6f-fd3a-41da-8799-352039c91e80\\\\configdrive.vhd</VAL\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C\
22ED2\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\1\\\\\\\\0\\\\\\\\D"<\
/VALUE></PROPERTY><PROPERTY NAME="PoolID"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="string"><VALUE>Microsoft:70BB60D2-A9D3-46aa-B654-3DE53004B4F8\\\\Root</\
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
...
-9EDA-2CA8B33039B4\\\\1\\\\0\\\\L"'
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="C7383415-\
32E8-4EDA-A528-08675B75DC4A"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 598 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="D23CEBB1\
-904A-41C6-9298-CF79C7EB1F23"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 621 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="E4359C48\
-7803-431C-BC53-D630440E4069"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
        elif len(args) == 0 and self.__id__ == 460:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:E5ED67FD-3244-4E93-807F-CB3BB7C22ED2\\\\83F8638B-8DCA-4152\
-9EDA-2CA8B33039B4\\\\1"'
        elif len(args) == 0 and self.__id__ == 464:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
        elif len(args) == 0 and self.__id__ == 557:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
...
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
        elif len(args) == 0 and self.__id__ == 622:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="E5ED67FD-3244-4E93-807F-CB3BB7C22ED2"'
    ...
    def Item(self, strName='<PyOleMissing object at 0x04091890>', iFlags=0):
        if self.__id__ == 68 and strName == u'InstanceID':
            ...
            return v
        elif self.__id__ == 376 and strName == u'InstanceID':
            v = CDispatch()
            v.__instance_id__ = 377
            return v
        elif self.__id__ == 380 and strName == u'ResourceSubType':
            v = CDispatch()
            v.__instance_id__ = 381
            return v
        elif self.__id__ == 384 and strName == u'HostResource':
            v = CDispatch()
            v.__instance_id__ = 385
            return v
        elif self.__id__ == 388 and strName == u'ElementName':
            v = CDispatch()
            v.__instance_id__ = 389
            return v
        elif self.__id__ == 392 and strName == u'Description':
            v = CDispatch()
            v.__instance_id__ = 393
            return v
        elif self.__id__ == 396 and strName == u'Parent':
            v = CDispatch()
            v.__instance_id__ = 397
            return v
        elif self.__id__ == 400 and strName == u'VirtualQuantity':
            v = CDispatch()
            v.__instance_id__ = 401
            return v
        elif self.__id__ == 404 and strName == u'AutomaticDeallocation':
            v = CDispatch()
            v.__instance_id__ = 405
            return v
        elif self.__id__ == 408 and strName == u'AutomaticAllocation':
            v = CDispatch()
            v.__instance_id__ = 409
            return v
        elif self.__id__ == 412 and strName == u'PoolID':
            v = CDispatch()
            v.__instance_id__ = 413
            return v
        elif self.__id__ == 416 and strName == u'Reservation':
            v = CDispatch()
            v.__instance_id__ = 417
            return v
        elif self.__id__ == 420 and strName == u'AllocationUnits':
            v = CDispatch()
            v.__instance_id__ = 421
            return v
        elif self.__id__ == 424 and strName == u'MappingBehavior':
            v = CDispatch()
            v.__instance_id__ = 425
            return v
        elif self.__id__ == 428 and strName == u'Address':
            v = CDispatch()
            v.__instance_id__ = 429
            return v
        elif self.__id__ == 432 and strName == u'OtherResourceType':
            v = CDispatch()
            v.__instance_id__ = 433
            return v
        elif self.__id__ == 436 and strName == u'Caption':
            v = CDispatch()
            v.__instance_id__ = 437
            return v
        elif self.__id__ == 440 and strName == u'ConsumerVisibility':
            v = CDispatch()
            v.__instance_id__ = 441
            return v
        elif self.__id__ == 444 and strName == u'Limit':
            v = CDispatch()
            v.__instance_id__ = 445
            return v
        elif self.__id__ == 448 and strName == u'ResourceType':
            v = CDispatch()
            v.__instance_id__ = 449
            return v
        elif self.__id__ == 452 and strName == u'Weight':
            v = CDispatch()
            v.__instance_id__ = 453
            return v
        elif self.__id__ == 454 and strName == u'VirtualSystemIdentifiers':
            v = CDispatch()
            v.__instance_id__ = 455
            return v
        elif self.__id__ == 458 and strName == u'Connection':
            v = CDispatch()
            v.__instance_id__ = 459
            return v
        elif self.__id__ == 470 and strName == u'InstanceID':
            v = CDispatch()
            v.__instance_id__ = 471
            return v
        elif self.__id__ == 474 and strName == u'ResourceSubType':
            v = CDispatch()
            v.__instance_id__ = 475
            return v
        elif self.__id__ == 478 and strName == u'HostResource':
            v = CDispatch()
            v.__instance_id__ = 479
            return v
        elif self.__id__ == 482 and strName == u'ElementName':
            v = CDispatch()
            v.__instance_id__ = 483
            return v
        elif self.__id__ == 486 and strName == u'Description':
            v = CDispatch()
            v.__instance_id__ = 487
            return v
        elif self.__id__ == 490 and strName == u'Parent':
            v = CDispatch()
            v.__instance_id__ = 491
            return v
        elif self.__id__ == 494 and strName == u'VirtualQuantity':
            v = CDispatch()
            v.__instance_id__ = 495
            return v
        elif self.__id__ == 498 and strName == u'AutomaticDeallocation':
            v = CDispatch()
            v.__instance_id__ = 499
            return v
        elif self.__id__ == 502 and strName == u'AutomaticAllocation':
            v = CDispatch()
            v.__instance_id__ = 503
            return v
        elif self.__id__ == 506 and strName == u'PoolID':
            v = CDispatch()
            v.__instance_id__ = 507
            return v
        elif self.__id__ == 510 and strName == u'Reservation':
            v = CDispatch()
            v.__instance_id__ = 511
            return v
        elif self.__id__ == 514 and strName == u'AllocationUnits':
            v = CDispatch()
            v.__instance_id__ = 515
            return v
        elif self.__id__ == 518 and strName == u'MappingBehavior':
            v = CDispatch()
            v.__instance_id__ = 519
            return v
        elif self.__id__ == 522 and strName == u'Address':
            v = CDispatch()
            v.__instance_id__ = 523
            return v
        elif self.__id__ == 526 and strName == u'OtherResourceType':
            v = CDispatch()
            v.__instance_id__ = 527
            return v
        elif self.__id__ == 530 and strName == u'Caption':
            v = CDispatch()
            v.__instance_id__ = 531
            return v
        elif self.__id__ == 534 and strName == u'ConsumerVisibility':
            v = CDispatch()
            v.__instance_id__ = 535
            return v
        elif self.__id__ == 538 and strName == u'Limit':
            v = CDispatch()
            v.__instance_id__ = 539
            return v
        elif self.__id__ == 542 and strName == u'ResourceType':
            v = CDispatch()
            v.__instance_id__ = 543
            return v
        elif self.__id__ == 546 and strName == u'Weight':
            v = CDispatch()
            v.__instance_id__ = 547
            return v
        elif self.__id__ == 548 and strName == u'VirtualSystemIdentifiers':
            v = CDispatch()
            v.__instance_id__ = 549
            return v
        elif self.__id__ == 552 and strName == u'Connection':
            v = CDispatch()
