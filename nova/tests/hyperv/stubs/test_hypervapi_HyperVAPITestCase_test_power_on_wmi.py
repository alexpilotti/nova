...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="36554119-F54C\
-4BAF-94F3-E9EFE73822EF"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="3393CA22-85A9\
-4A51-BFED-99FB36E4B947"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="36C78030-D2B\
B-4ED8-A18D-DC8236279EB5"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="A645DBDB-D57\
D-42A5-AB0D-9A2D5A2ED30D"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="D76BE52A-EAD\
D-4A9F-9300-61B3CB912052"':
        ret_value = None
        global _WMI_count_8
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="159665F0-3AD\
C-4D7E-B224-9F3EA8CB4397"':
        ret_value = None
        global _WMI_count_9
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="14E764D4-D1F\
6-4867-B981-BFCB3A370B06"':
        ret_value = None
...
7ee2b\'':
            v = []
            return v
        elif self.__id__ == 383 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_2f35331e-c669-46af-9f3\
1-a893a7e3db2a\\openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a':
            v = []
            v1 = _wmi_object()
 ...
 'openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 384 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.010868:000'
        elif self.__id__ == 359:
            return u'00000000000000.730163:000'
        elif self.__id__ == 372:
            return u'00000000000000.648671:000'
    ...
    def Connection(self):
        if self.__id__ == 405:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_2f35331e-c669-46af-9f3\
1-a893a7e3db2a\\openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a.vh\
d'
            v += (v1,)
            return v
    ...
    def JobState(self):
        if self.__id__ == 14:
            ...
            ret_value = None
            if not hasattr(self, '_JobState_count_30'):
                self._JobState_count_30 = 0
            if self._JobState_count_30 == 0:
                v = 7
            elif self._JobState_count_30 == 1:
                v = 7
            self._JobState_count_30 += 1
            return v
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 374 and wmi_association_class ==\
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 395 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 394 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
...
Data.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:D0CF26DA-4E\
C8-4BDE-976D-529ABC1AD5F5\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\4764334d\
...
ingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:D0CF26DA\
-4EC8-4BDE-976D-529ABC1AD5F5\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3d\
b2a</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>9de0c733-c249-4e58-8faf-d4ab20d36a7b</VALUE\
...
t_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a\\openstack_unit_test_vm_2f35331\
e-c669-46af-9f31-a893a7e3db2a.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>ed3fc03c-5994-4c64-937a-ff6edfe29b90</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{e0d9a8ea-e946-495d-bd5c-d926dffc4738}</VAL\
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 416:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 24 and kwargs.get('Path') ==\
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_2f35331e-c669-46af-9f31\
-a893a7e3db2a\\openstack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="3393CA22-\
85A9-4A51-BFED-99FB36E4B947"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="36C78030\
-D2BB-4ED8-A18D-DC8236279EB5"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 367 and args[0] == 2:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="D76BE52A\
-EADD-4A9F-9300-61B3CB912052"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"' and\
...
ySettingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:D0CF26DA-4E\
C8-4BDE-976D-529ABC1AD5F5\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:D0CF26DA\
-4EC8-4BDE-976D-529ABC1AD5F5\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1\
AD5F5\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_2f35331e-c669-46af-9f31-a893a7e3db2a\\\\openstack_unit_test_\
vm_2f35331e-c669-46af-9f31-a893a7e3db2a.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1\
AD5F5\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\37BDA7F4-6B92-4F4F\
-AC05-18F690B6D1F3\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{b5c51f43-b789-4d18-8735-63dd2d09527e}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5\\\\49FAEBDF-D5E6-4\
0B7-A257-94FD9BC16E2D"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="36554119-\
F54C-4BAF-94F3-E9EFE73822EF"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 362 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="A645DBDB\
-D57D-42A5-AB0D-9A2D5A2ED30D"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 390 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="159665F0\
-3ADC-4D7E-B224-9F3EA8CB4397"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 379 and str(args[0]) == '[100,\
 105]' and str(args[1]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_VirtualSystemSettingD\
ata.InstanceID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"\']':
            v = ()
            v1 = 0
            v += (v1,)
            v1 = []
            v2 = CDispatch()
            v2.__instance_id__ = 380
            v1.append(v2)
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 411 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="14E764D4\
-D1F6-4867-B981-BFCB3A370B06"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"'
        elif len(args) == 0 and self.__id__ == 378:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_VirtualSystemSettingData.Instanc\
eID="Microsoft:D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"'
        elif len(args) == 0 and self.__id__ == 412:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="D0CF26DA-4EC8-4BDE-976D-529ABC1AD5F5"'
