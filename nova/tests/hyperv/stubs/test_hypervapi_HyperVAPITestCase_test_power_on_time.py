...
def gmtime(*p):
 ...
 tm_hour=22, tm_min=58, tm_sec=30, tm_wday=6, tm_yday=6, tm_isdst=0)'


def strftime(*p):
    if len(p) == 2 and p[0] == '%Y-%m-%dT%H:%M:%SZ' and str(p[1]) ==\
 'time.struct_time(tm_year=2013, tm_mon=1, tm_mday=6, tm_hour=22, tm_min=58,\
 tm_sec=30, tm_wday=6, tm_yday=6, tm_isdst=0)':
        return '2013-01-06T22:58:30Z'
