...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="C1D851CA-DD00\
-4D59-929B-E50E52826FC8"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="9ACECEAD-06F7\
-4970-9641-093D90A335C9"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="AD841545-2D5\
D-432E-8EFF-C55899EA90DE"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="E6A50E0B-734\
9-40BB-B45A-5377D5229BC8"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="EE7577D7-D61\
7-44DA-8D33-B18ABEBE89EF"':
        ret_value = None
        global _WMI_count_8
...
7ee2b\'':
            v = []
            return v
        elif self.__id__ == 362 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_bad45503-0183-4188-a60\
b-d3e33c943bdc\\openstack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc.vh\
d\'':
            v = []
            v1 = _wmi_object()
...
class _wmi_class(object):
 ...
 'openstack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc':
            v = []
            v1 = _wmi_object()
...
class _wmi_object(object):
    ...
    def ElapsedTime(self):
        if self.__id__ == 34:
            return u'00000000000001.004461:000'
        elif self.__id__ == 359:
            return u'00000000000000.647160:000'
    ...
    def Connection(self):
        if self.__id__ == 384:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_bad45503-0183-4188-a60\
b-d3e33c943bdc\\openstack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc.vh\
d'
            v += (v1,)
            return v
...
Data.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:BA968CDA-08\
22-436E-9567-37A635EF7D31\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\4764334d\
...
ingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:BA968CDA\
-0822-436E-9567-37A635EF7D31\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943\
bdc</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>94603540-0ec3-476d-ac0d-8d75da25fd46</VALUE\
...
t_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc\\openstack_unit_test_vm_bad4550\
3-0183-4188-a60b-d3e33c943bdc.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>b8d32e7c-78b0-4269-b305-864d359e5a62</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{994e005c-dcd4-44b1-8f12-66901745e781}</VAL\
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 395:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 25 and kwargs.get('Path') ==\
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_bad45503-0183-4188-a60b\
-d3e33c943bdc\\openstack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="9ACECEAD-\
06F7-4970-9641-093D90A335C9"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="AD841545\
-2D5D-432E-8EFF-C55899EA90DE"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="BA968CDA-0822-436E-9567-37A635EF7D31"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="BA968CDA-0822-436E-9567-37A635EF7D31"' and\
...
ySettingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:BA968CDA-08\
22-436E-9567-37A635EF7D31\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:BA968CDA\
-0822-436E-9567-37A635EF7D31\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635E\
F7D31\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_bad45503-0183-4188-a60b-d3e33c943bdc\\\\openstack_unit_test_\
vm_bad45503-0183-4188-a60b-d3e33c943bdc.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635E\
F7D31\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
="Msvm_ComputerSystem",Name="BA968CDA-0822-436E-9567-37A635EF7D31"':
            ...
            v2 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\4B9AAC40-BB41-43CA\
-94D2-F9FD8C9ABF21\\\\0"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{ec07bc1e-a5fd-47df-a163-ef72ca50c7d7}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:BA968CDA-0822-436E-9567-37A635EF7D31\\\\FB93540F-AD89-4\
3E8-89E7-FEB6758FBF3A"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="C1D851CA-\
DD00-4D59-929B-E50E52826FC8"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 369 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="E6A50E0B\
-7349-40BB-B45A-5377D5229BC8"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="BA968CDA-0822-436E-9567-37A635EF7D31"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="EE7577D7\
-D617-44DA-8D33-B18ABEBE89EF"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
