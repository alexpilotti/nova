...
def gmtime(*p):
 ...
 tm_hour=20, tm_min=13, tm_sec=22, tm_wday=3, tm_yday=3, tm_isdst=0)'


def strftime(*p):
    if len(p) == 2 and p[0] == '%Y-%m-%dT%H:%M:%SZ' and str(p[1]) ==\
 'time.struct_time(tm_year=2013, tm_mon=1, tm_mday=3, tm_hour=20, tm_min=13,\
 tm_sec=22, tm_wday=3, tm_yday=3, tm_isdst=0)':
        return '2013-01-03T20:13:22Z'
