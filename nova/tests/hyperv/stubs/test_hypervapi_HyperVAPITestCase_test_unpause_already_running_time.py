...
def gmtime(*p):
 ...
 tm_hour=23, tm_min=0, tm_sec=25, tm_wday=6, tm_yday=6, tm_isdst=0)'


def strftime(*p):
    if len(p) == 2 and p[0] == '%Y-%m-%dT%H:%M:%SZ' and str(p[1]) ==\
 'time.struct_time(tm_year=2013, tm_mon=1, tm_mday=6, tm_hour=23, tm_min=0,\
 tm_sec=25, tm_wday=6, tm_yday=6, tm_isdst=0)':
        return '2013-01-06T23:00:25Z'
