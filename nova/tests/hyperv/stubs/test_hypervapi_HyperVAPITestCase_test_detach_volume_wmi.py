...
def WMI(computer='', impersonation_level='', authentication_level='',
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="D0E2353A-3606\
-483D-B6ED-76DF1E003FE7"':
        ret_value = None
        global _WMI_count_4
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_StorageJob.InstanceID="5FB35FCC-DB74\
-428D-8956-9F013FAC113B"':
        ret_value = None
        global _WMI_count_5
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="156C81F1-B07\
2-4E40-A644-E1A751C353AA"':
        ret_value = None
        global _WMI_count_6
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="1773F5EC-E46\
4-4A10-81BB-EB4C6A4DFD8B"':
        ret_value = None
        global _WMI_count_7
 ...
 u'//HV12OSDEMO1/root/virtualization:Msvm_ConcreteJob.InstanceID="DBA96B84-55A\
F-41CF-BD59-4ED96DBE128E"':
        ret_value = None
        global _WMI_count_8
...
7ee2b\'':
            ...
            if self._query_count_1 == 0:
                ...
                v = []
                v1 = _wmi_object()
                v1.__instance_id__ = 486
                v.append(v1)
            self._query_count_1 += 1
            return v
        elif self.__id__ == 530 and wql == u'Select * from CIM_DataFile where\
 Name =\
 \'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44\
a-f0f6c89e02db\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db.vh\
d\'':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 562
            v.append(v1)
            return v
 ...
 Msvm_ImageManagementService':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 369 and wql == 'SELECT * FROM Msvm_DiskDrive WHERE\
 DriveNumber=1':
            ret_value = None
            ...
            if self._query_count_8 == 0:
                ...
                v = []
                v1 = _wmi_object()
                v1.__instance_id__ = 489
                v.append(v1)
            elif self._query_count_8 == 3:
                v = []
                v1 = _wmi_object()
                v1.__instance_id__ = 490
                v.append(v1)
            self._query_count_8 += 1
            return v
        elif self.__id__ == 369 and wql == u'SELECT * FROM\
 Msvm_ResourceAllocationSettingData                 WHERE ResourceSubType LIKE\
 \'Microsoft Physical Disk Drive\'                AND Parent =\
 \'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\C7E7487A-FDE4-47B0\
-9DCD-8B48F3D3264C\\\\0"\'':
            v = []
            return v
        elif self.__id__ == 369 and wql == 'SELECT * FROM\
 Msvm_ResourceAllocationSettingData                 WHERE ResourceSubType LIKE\
 ...
 \'Microsoft Physical Disk Drive\'':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 491
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 492
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 493
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 494
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 495
            v.append(v1)
            return v
...
class _wmi_class(object):
    ...
    def __call__(self, fields='[]', **where_clause):
        if self.__id__ == 506 and where_clause.get('TargetNodeAddress') ==\
 'iqn.2010-10.org.openstack:volume-ccb39627-34fa-4f47-968b-6580d9d7ee2b':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 507
            v.append(v1)
            return v
        elif self.__id__ == 504 and where_clause.get('NodeAddress') ==\
 'iqn.2010-10.org.openstack:volume-ccb39627-34fa-4f47-968b-6580d9d7ee2b':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 505
            v.append(v1)
            return v
        elif self.__id__ == 5:
            v = []
 ...
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
 ...
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 511
            v.append(v1)
            return v
        elif self.__id__ == 528 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 531 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 535 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 540 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 372 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 497 and where_clause.get('ElementName') ==\
 'openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 498
            v.append(v1)
            return v
        elif self.__id__ == 482:
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 483
            v.append(v1)
            return v
        elif self.__id__ == 499:
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 500
            v.append(v1)
            return v
...
stemCreationClassName="Msvm_ComputerSystem",SystemName="HV12OSDEMO1"'
    ...
    def Devices(self):
        if self.__id__ == 366:
            ...
            v = ()
            v1 = CDispatch()
            v1.__instance_id__ = 487
            v += (v1,)
            v1 = CDispatch()
            v1.__instance_id__ = 488
            v += (v1,)
            return v
    ...
    def ElapsedTime(self):
        if self.__id__ == 33:
            return u'00000000000001.010825:000'
        elif self.__id__ == 359:
            return u'00000000000000.787246:000'
    ...
    def Connection(self):
        if self.__id__ == 522:
            v = ()
            v1 =\
 u'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44\
a-f0f6c89e02db\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db.vh\
d'
            v += (v1,)
            return v
...
d'
 ...
 'Msvm_VirtualSystemSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 512 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 513
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 514
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 515
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 516
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 517
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 518
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 519
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 520
            v.append(v1)
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 511 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
            ...
            v.append(v1)
            return v
        elif self.__id__ == 542 and wmi_result_class ==\
 'MSVM_ResourceAllocationSettingData':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 543
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 544
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 545
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 546
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 547
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 548
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 549
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 550
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 551
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 552
            v.append(v1)
            v1 = _wmi_object()
            ...
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 556
            v.append(v1)
            v1 = _wmi_object()
            v1.__instance_id__ = 557
            v.append(v1)
            return v
        elif self.__id__ == 541 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
            v1.__instance_id__ = 542
            v.append(v1)
            return v
 ...
 'MSVM_ResourceAllocationSettingData':
            ...
            v.append(v1)
            return v
        elif self.__id__ == 373 and wmi_result_class ==\
 'Msvm_VirtualSystemSettingData':
            v = []
            v1 = _wmi_object()
...
Data.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\4764334d-e0\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:B20D6E23-71\
EF-4D67-8E64-7C6569B29979\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE></PR\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"><VALUE>Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\4764334d\
...
ingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\b637f346\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:B20D6E23\
-71EF-4D67-8E64-7C6569B29979\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\\\\0"</VA\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\b637f346\
-6a0e-4dec-af52-bd70cb80a21d\\0</VALUE></PROPERTY><PROPERTY\
...
ROPERTY NAME="__GENUS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY><PROPERTY NAME="ElementName"\
 CLASSORIGIN="CIM_ManagedElement"\
 TYPE="string"><VALUE>openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e0\
2db</VALUE></PROPERTY><PROPERTY NAME="ExternalDataRoot"\
 CLASSORIGIN="Msvm_VirtualSystemGlobalSettingData" PROPAGATED="true"\
...
ationSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 TYPE="string"><VALUE.ARRAY><VALUE>40722a0c-46f2-4c7c-a921-477faf7b6d1d</VALUE\
...
t_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db\\openstack_unit_test_vm_17c25ba\
4-1c3a-4769-a44a-f0f6c89e02db.vhd</VALUE></VALUE.ARRAY></PROPERTY.ARRAY><PROPE\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>8be3cad2-beab-481a-89e7-a54ea28bdcdf</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{2217e215-a762-41cb-90ac-3f11519f411b}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
        elif self.__id__ == 393 and iObjectTextFormat == 1:
            return u'<INSTANCE\
 CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY NAME="__PATH"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__NAMESPACE"\
 CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY NAME="__SERVER"\
...
36\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAlloc\
ationSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\
\\\\C7E7487A-FDE4-47B0-9DCD-8B48F3D3264C\\\\0"</VALUE></PROPERTY><PROPERTY\
 NAME="PoolID" CLASSORIGIN="CIM_ResourceAllocationSettingData"\
...
LUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_ResourceAllocationSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>cca8f7cf-ed9f-41f7-9577-7039711322e4</VALUE\
></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>'
...
class _wmi_method(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) == 0 and self.__id__ == 508:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 364 and\
 ...
 'iqn.2010-10.org.openstack:volume-ccb39627-34fa-4f47-968b-6580d9d7ee2b':
            ...
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 509:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 361 and\
 ...
 kwargs.get('TargetPortalPortNumber') == '3260':
            ...
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 563:
            v = ()
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 0 and self.__id__ == 24 and kwargs.get('Path') ==\
 'C:\\Hyper-V\\test\\instances\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a\
-f0f6c89e02db\\openstack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db.vhd\
' and kwargs.get('ParentPath') == 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="5FB35FCC-\
DB74-428D-8956-9F013FAC113B"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
            ...
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="156C81F1\
-B072-4E40-A644-E1A751C353AA"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
...
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
            v += (v1,)
            v1 = None
            v += (v1,)
            v1 = 0
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"' and\
...
ySettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_MemorySettingData.InstanceID="Microsoft:B20D6E23-71\
EF-4D67-8E64-7C6569B29979\\\\\\\\4764334d-e001-4176-82ee-5594ec9b530e"</VALUE>\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\476433\
...
ssorSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\
...
ROPERTY.ARRAY><PROPERTY NAME="__PROPERTY_COUNT" CLASSORIGIN="___SYSTEM"\
 ...
 CLASSORIGIN="___SYSTEM"\
 TYPE="string"><VALUE>Msvm_ProcessorSettingData.InstanceID="Microsoft:B20D6E23\
-71EF-4D67-8E64-7C6569B29979\\\\\\\\b637f346-6a0e-4dec-af52-bd70cb80a21d\
...
PERTY NAME="__CLASS" CLASSORIGIN="___SYSTEM"\
 ...
 TYPE="string"></PROPERTY.ARRAY><PROPERTY NAME="InstanceID"\
 CLASSORIGIN="CIM_SettingData"\
 TYPE="string"><VALUE>Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\b637f3\
...
rceAllocationSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B\
29979\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0"</VALUE></PROPERTY>\
...
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\83F8638B-8DCA-4152\
...
tack_unit_test_vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db\\\\openstack_unit_test_\
vm_17c25ba4-1c3a-4769-a44a-f0f6c89e02db.vhd</VALUE></VALUE.ARRAY></PROPERTY.AR\
...
B4F8\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B\
29979\\\\\\\\83F8638B-8DCA-4152-9EDA-2CA8B33039B4\\\\\\\\0\\\\\\\\0\\\\\\\\D"<\
...
VALUE></PROPERTY><PROPERTY NAME="Reservation"\
 ...
 NAME="VirtualSystemIdentifiers"\
 CLASSORIGIN="Msvm_SyntheticEthernetPortSettingData"\
 TYPE="string"><VALUE.ARRAY><VALUE>{beca3ac8-daa7-4e95-b011-fccca72b615a}</VAL\
UE></VALUE.ARRAY></PROPERTY.ARRAY><PROPERTY NAME="Weight"\
 CLASSORIGIN="CIM_ResourceAllocationSettingData"\
 TYPE="uint32"><VALUE>0</VALUE></PROPERTY></INSTANCE>\']' and args[1] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
...
.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\7C6F3FC3-5C36-4\
F3A-8DFA-70B906B8C9B1"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
 ...
 'C:\\Hyper-V\\test\\instances\\_base\\1.vhd':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_StorageJob.InstanceID="D0E2353A-\
3606-483D-B6ED-76DF1E003FE7"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 537 and args[0] == 3:
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="1773F5EC\
-E464-4A10-81BB-EB4C6A4DFD8B"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 1 and self.__id__ == 558 and args[0] ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"':
            v = ()
            v1 =\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ConcreteJob.InstanceID="DBA96B84\
-55AF-41CF-BD59-4ED96DBE128E"'
            v += (v1,)
            v1 = 4096
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 484 and str(args[0]) ==\
 '[u\'<INSTANCE CLASSNAME="Msvm_ResourceAllocationSettingData"><PROPERTY\
 NAME="__PATH" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__NAMESPACE" CLASSORIGIN="___SYSTEM" TYPE="string"></PROPERTY><PROPERTY\
 NAME="__SERVER" CLASSORIGIN="___SYSTEM"\
...
6136\\\\Default</VALUE></PROPERTY><PROPERTY NAME="Limit"\
 ...
 TYPE="string"><VALUE>\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_Resou\
rceAllocationSettingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B\
29979\\\\\\\\C7E7487A-FDE4-47B0-9DCD-8B48F3D3264C\\\\\\\\0"</VALUE></PROPERTY>\
<PROPERTY NAME="PoolID" CLASSORIGIN="CIM_ResourceAllocationSettingData"\
...
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"':
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\C7E7487A-FDE4-47B0\
-9DCD-8B48F3D3264C\\\\0\\\\0\\\\D"'
            v1.append(v2)
            v += (v1,)
            v1 = 0
            v += (v1,)
            return v
        elif len(args) == 2 and self.__id__ == 501 and str(args[0]) ==\
 '[u\'\\\\\\\\HV12OSDEMO1\\\\root\\\\virtualization:Msvm_ResourceAllocationSet\
tingData.InstanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\\\\\C7E\
7487A-FDE4-47B0-9DCD-8B48F3D3264C\\\\\\\\0\\\\\\\\0\\\\\\\\D"\']' and args[1]\
 ==\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"':
            v = ()
...
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
 ...
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
        elif len(args) == 0 and self.__id__ == 559:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
...
m_DiskDrive",DeviceID="Microsoft:353B3BE8-310C-4cf4-839E-4E1B14616136\\\\1",Sy\
stemCreationClassName="Msvm_ComputerSystem",SystemName="HV12OSDEMO1"'
        elif len(args) == 0 and self.__id__ == 496:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_DiskDrive.CreationClassName="Msv\
m_DiskDrive",DeviceID="Microsoft:353B3BE8-310C-4cf4-839E-4E1B14616136\\\\1",Sy\
stemCreationClassName="Msvm_ComputerSystem",SystemName="HV12OSDEMO1"'
        elif len(args) == 0 and self.__id__ == 502:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\C7E7487A-FDE4-47B0\
-9DCD-8B48F3D3264C\\\\0\\\\0\\\\D"'
        elif len(args) == 0 and self.__id__ == 390:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\C7E7487A-FDE4-47B0\
-9DCD-8B48F3D3264C\\\\0"'
        elif len(args) == 0 and self.__id__ == 480:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ResourceAllocationSettingData.In\
stanceID="Microsoft:B20D6E23-71EF-4D67-8E64-7C6569B29979\\\\C7E7487A-FDE4-47B0\
-9DCD-8B48F3D3264C\\\\0"'
        elif len(args) == 0 and self.__id__ == 485:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
        elif len(args) == 0 and self.__id__ == 503:
            return\
 u'\\\\HV12OSDEMO1\\root\\virtualization:Msvm_ComputerSystem.CreationClassName\
="Msvm_ComputerSystem",Name="B20D6E23-71EF-4D67-8E64-7C6569B29979"'
    ...
    def Item(self, strName='<PyOleMissing object at 0x040917C0>', iFlags=0):
        if self.__id__ == 66 and strName == u'InstanceID':
            ...
            return v
        elif self.__id__ == 394 and strName == u'InstanceID':
            v = CDispatch()
            v.__instance_id__ = 395
            return v
        elif self.__id__ == 398 and strName == u'ResourceSubType':
            v = CDispatch()
            v.__instance_id__ = 399
            return v
        elif self.__id__ == 402 and strName == u'HostResource':
            v = CDispatch()
            v.__instance_id__ = 403
            return v
        elif self.__id__ == 406 and strName == u'ElementName':
            v = CDispatch()
            v.__instance_id__ = 407
            return v
        elif self.__id__ == 410 and strName == u'Description':
            v = CDispatch()
            v.__instance_id__ = 411
            return v
        elif self.__id__ == 414 and strName == u'Parent':
            v = CDispatch()
            v.__instance_id__ = 415
            return v
        elif self.__id__ == 418 and strName == u'VirtualQuantity':
            v = CDispatch()
            v.__instance_id__ = 419
            return v
        elif self.__id__ == 422 and strName == u'AutomaticDeallocation':
            v = CDispatch()
            v.__instance_id__ = 423
            return v
        elif self.__id__ == 426 and strName == u'AutomaticAllocation':
            v = CDispatch()
            v.__instance_id__ = 427
            return v
        elif self.__id__ == 430 and strName == u'PoolID':
            v = CDispatch()
            v.__instance_id__ = 431
            return v
        elif self.__id__ == 434 and strName == u'Reservation':
            v = CDispatch()
            v.__instance_id__ = 435
            return v
        elif self.__id__ == 438 and strName == u'AllocationUnits':
            v = CDispatch()
            v.__instance_id__ = 439
            return v
        elif self.__id__ == 442 and strName == u'MappingBehavior':
            v = CDispatch()
            v.__instance_id__ = 443
            return v
        elif self.__id__ == 446 and strName == u'Address':
            v = CDispatch()
            v.__instance_id__ = 447
            return v
        elif self.__id__ == 450 and strName == u'OtherResourceType':
            v = CDispatch()
            v.__instance_id__ = 451
            return v
        elif self.__id__ == 454 and strName == u'Caption':
            v = CDispatch()
            v.__instance_id__ = 455
            return v
        elif self.__id__ == 458 and strName == u'ConsumerVisibility':
            v = CDispatch()
            v.__instance_id__ = 459
            return v
        elif self.__id__ == 462 and strName == u'Limit':
            v = CDispatch()
            v.__instance_id__ = 463
            return v
        elif self.__id__ == 466 and strName == u'ResourceType':
            v = CDispatch()
            v.__instance_id__ = 467
            return v
        elif self.__id__ == 470 and strName == u'Weight':
            v = CDispatch()
            v.__instance_id__ = 471
            return v
        elif self.__id__ == 476 and strName == u'Connection':
            v = CDispatch()
            ...
            return v
        elif self.__id__ == 474 and strName == u'VirtualSystemIdentifiers':
            v = CDispatch()
